...
namespace CommonService.BLL.OA
{
    ...
    {
        private readonly CommonService.DAL.OA.O_Chats dal = new DAL.OA.O_Chats();
        public O_Chats()
        { }
        #region  BasicMethod
        /// <summary>
        ...
        {
            return dal.DeleteList(O_Chats_idlist);
        }
        ...
        public CommonService.Model.OA.O_Chats GetModel(int O_Chats_id)
        {
            ...
            return dal.GetModel(O_Chats_id);
        }
        ...
        public CommonService.Model.OA.O_Chats GetModelByCache(int O_Chats_id)
        {
            ...
            string CacheKey = "O_ChatsModel-" + O_Chats_id;
            object objModel = Maticsoft.Common.DataCache.GetCache(CacheKey);
            if (objModel == null)
            {
                try
                {
                    objModel = dal.GetModel(O_Chats_id);
                    if (objModel != null)
                    {
            ...
            return (CommonService.Model.OA.O_Chats)objModel;
        }
        ...
        {
            List<CommonService.Model.OA.O_Chats> modelList = new List<CommonService.Model.OA.O_Chats>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                CommonService.Model.OA.O_Chats model;
