...
{
    public class R_LitigationCase_ReportingController : BaseController
    {
        //
        private readonly ICommonService.Reporting.IR_LitigationCase_Reporting _reporting_CaseWCF;
        // GET: /Reporting/R_LitigationCase_Reporting/
        public R_LitigationCase_ReportingController()
        {
            _reporting_CaseWCF = ServiceProxyFactory.Create<ICommonService.Reporting.IR_LitigationCase_Reporting>("R_LitigationCase_ReportingWCF");
        }
        ...
        public ActionResult AjaxList(jQueryDataTableParamModel param)
        {
            ...
            //s_number
            //表单查询模型
            CommonService.Model.Reporting.R_LitigationCase_Reporting oFormConditon = new CommonService.Model.Reporting.R_LitigationCase_Reporting();
            ...
            List<CommonService.Model.Reporting.R_LitigationCase_Reporting> listsLoan = _reporting_CaseWCF.GetListByPage("", " ID asc ", param.iDisplayStart + 1, param.iDisplayStart + param.iDisplayLength);
        ...
        public FileResult Export()
        {
            ...
            List<CommonService.Model.Reporting.R_LitigationCase_Reporting> listsLoan = _reporting_CaseWCF.GetListByPage("", " ID asc ", 1, 1000000);
            ...
            row1.CreateCell(12).SetCellValue("管辖法院");
            row1.CreateCell(13).SetCellValue("本月案件进展");
            row1.CreateCell(14).SetCellValue("进展完成时间");
            row1.CreateCell(15).SetCellValue("保全状态");
            row1.CreateCell(16).SetCellValue("生效状态");
            ...
            for (int i = 0; i < listsLoan.Count; i++)
            {
                ...
                rowtemp.CreateCell(11).SetCellValue(listsLoan[i].B_ExpectedPrice);
                rowtemp.CreateCell(12).SetCellValue(listsLoan[i].JurisdictionCourt);
                rowtemp.CreateCell(13).SetCellValue(listsLoan[i].ProgressCompletionTime);
                rowtemp.CreateCell(14).SetCellValue(listsLoan[i].PreservationState);
                rowtemp.CreateCell(15).SetCellValue(listsLoan[i].EffectiveState);
                rowtemp.CreateCell(16).SetCellValue(listsLoan[i].DocumentIncome);
