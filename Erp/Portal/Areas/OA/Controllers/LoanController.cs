...
namespace Portal.Areas.OA.Controllers
{
    public class LoanController : BaseController
    {
        ...
        public ActionResult AjaxList(jQueryDataTableParamModel param)
        {
            ...
            string formCode = "76D963E9-BE8D-42D0-87F8-657CB294108B";//借款单Guid(固定值)
            ...
            {//代表已执行查询
                ...
                {
                    condition = condition + "and \"390C588F-998B-437A-940A-7198FA536023\" = " + Convert.ToInt32(stste);
                }
                string state_type = Request.Params.Get("i_state_type");//发票类型
                if (!String.IsNullOrEmpty(state_type) && state_type.ToString() != "-1")
                {
                    condition = condition + "and \"BA2301EF-D01A-4800-A9ED-B5CE8680D1BC\" = " + Convert.ToInt32(state_type);
                }
            ...
            List<CommonService.Model.C_Parameters> listP = _parameterWCF.GetListByPage(modelP, "", 0, 1000);
            ...
            if (itemFormPropertyValues.Tables.Count!=0)
            {
                for (int i = 0; i < itemFormPropertyValues.Tables[0].Rows.Count; i++)
                {
                    ...
                    if (itemFormPropertyValues.Tables[0].Rows[i]["783DEBB9-9B93-4BD9-83DF-7D3F8C373AB9"] != null && itemFormPropertyValues.Tables[0].Rows[i]["783DEBB9-9B93-4BD9-83DF-7D3F8C373AB9"].ToString() != "")
                    {
                        model.Consttype = itemFormPropertyValues.Tables[0].Rows[i]["783DEBB9-9B93-4BD9-83DF-7D3F8C373AB9"].ToString();
                        model.Consttype = listP.FirstOrDefault(p => p.C_Parameters_id == Convert.ToInt32(model.Consttype)).C_Parameters_name;
                    }
                    if (itemFormPropertyValues.Tables[0].Rows[i]["BA2301EF-D01A-4800-A9ED-B5CE8680D1BC"] != null && itemFormPropertyValues.Tables[0].Rows[i]["BA2301EF-D01A-4800-A9ED-B5CE8680D1BC"].ToString() != "")
                    {
                        model.Invoicetype = itemFormPropertyValues.Tables[0].Rows[i]["BA2301EF-D01A-4800-A9ED-B5CE8680D1BC"].ToString();
                        model.Invoicetype = listP.FirstOrDefault(p => p.C_Parameters_id == Convert.ToInt32(model.Invoicetype)).C_Parameters_name;
                    }

                    if (itemFormPropertyValues.Tables[0].Rows[i]["3257AA6F-E1DD-49B7-ABE4-B3BB4618FD66"] != null && itemFormPropertyValues.Tables[0].Rows[i]["3257AA6F-E1DD-49B7-ABE4-B3BB4618FD66"].ToString() != "")
                    {
                        model.Invoicevalue = itemFormPropertyValues.Tables[0].Rows[i]["3257AA6F-E1DD-49B7-ABE4-B3BB4618FD66"].ToString();

                    }
                    if (itemFormPropertyValues.Tables[0].Rows[i]["745CB554-3F70-4C07-8952-D6D3190F63B8"] != null && itemFormPropertyValues.Tables[0].Rows[i]["745CB554-3F70-4C07-8952-D6D3190F63B8"].ToString() != "")
                    {
                        model.Abstracts = itemFormPropertyValues.Tables[0].Rows[i]["745CB554-3F70-4C07-8952-D6D3190F63B8"].ToString();

                    }
                    if (itemFormPropertyValues.Tables[0].Rows[i]["279CD727-D37D-401B-BF72-15CAC897D075"] != null && itemFormPropertyValues.Tables[0].Rows[i]["279CD727-D37D-401B-BF72-15CAC897D075"].ToString() != "")
                    {
                        model.Dateofcost = itemFormPropertyValues.Tables[0].Rows[i]["279CD727-D37D-401B-BF72-15CAC897D075"].ToString();
                    ...
                    if (itemFormPropertyValues.Tables[0].Rows[i]["390C588F-998B-437A-940A-7198FA536023"] != null && itemFormPropertyValues.Tables[0].Rows[i]["390C588F-998B-437A-940A-7198FA536023"].ToString() != "")
                    {
                        model.Paymentstatus = itemFormPropertyValues.Tables[0].Rows[i]["390C588F-998B-437A-940A-7198FA536023"].ToString();
        ...
        private string GetRolePowers()
        {
            ...
            if (!UIContext.Current.IsPreSetManager)
            {
                List<CommonService.Model.SysManager.C_Role_Role_Power> Role_RolePowers = _roleRolePower.GetRolePowersByUserCode(UIContext.Current.UserCode.Value);
        ...
        {
            string reimCode = "76D963E9-BE8D-42D0-87F8-657CB294108B";//借款单Guid(固定值)
            ...
            if (!String.IsNullOrEmpty(formCode))
            {
                ...
                if (itemFormPropertyValue.Tables.Count != 0)
                {
                    if (itemFormPropertyValue.Tables[0].Rows.Count != 0)
                    {
                        ...
                        {
                            string paytype = listP.FirstOrDefault(p => p.C_Parameters_id == Convert.ToInt32(itemFormPropertyValue.Tables[0].Rows[i]["BA2301EF-D01A-4800-A9ED-B5CE8680D1BC"])).C_Parameters_name;//费用类型
                            string mony = "";//费用金额
                            if (itemFormPropertyValue.Tables[0].Rows[i]["3257AA6F-E1DD-49B7-ABE4-B3BB4618FD66"] != null)
                            {
                                mony = itemFormPropertyValue.Tables[0].Rows[i]["3257AA6F-E1DD-49B7-ABE4-B3BB4618FD66"].ToString();
