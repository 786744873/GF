...
namespace CommonService.KMS
{
    ...
    public class K_Browse_Log : IK_Browse_Log
    {
        private readonly CommonService.BLL.KMS.K_Browse_Log bll = new CommonService.BLL.KMS.K_Browse_Log();
        public K_Browse_Log()
        { }
        #region  BasicMethod
        /// <summary>
        ...
        {
            return bll.Exists(K_Browse_Log_id);
        }
        ...
        public bool Delete(int K_Browse_Log_id)
        {
            ...
            return bll.Delete(K_Browse_Log_id);
        }
        ...
        public CommonService.Model.KMS.K_Browse_Log GetModel(int K_Browse_Log_id)
        {
            ...
            return bll.GetModel(K_Browse_Log_id);
        }
        /// <summary>
        /// 获得前几行数据
        /// </summary>
        ...
        {
            return bll.GetBrowseCount(P_FK_code, groupBy);
        }
