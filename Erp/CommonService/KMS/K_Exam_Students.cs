...
{
    public partial class K_Exam_Students : IK_Exam_Students
    {
        CommonService.BLL.KMS.K_Exam_Students bll = new CommonService.BLL.KMS.K_Exam_Students();
        ...
        {
            return bll.Exists(K_Exam_Students_code);
        }
        ...
        public bool Delete(Guid K_Exam_Students_code)
        {
            ...
            return bll.Delete(K_Exam_Students_code);
        }
        ...
        public CommonService.Model.KMS.K_Exam_Students GetModel(Guid K_Exam_Students_code)
        {
            ...
            return bll.GetModel(K_Exam_Students_code);
        }
