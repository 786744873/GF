...
{
    // 注意: 使用“重构”菜单上的“重命名”命令，可以同时更改代码和配置文件中的类名“R_LitigationCase_Reporting”。
    public class R_LitigationCase_Reporting : IR_LitigationCase_Reporting
    {
        private readonly BLL.Reporting.R_LitigationCase_Reporting dal = new BLL.Reporting.R_LitigationCase_Reporting();
        ...
        /// 获得数据列表
        /// </summary>
        public List<Model.Reporting.R_LitigationCase_Reporting> GetList(string strWhere)
        {
        ...
        /// 获得前几行数据
        /// </summary>
        public List<Model.Reporting.R_LitigationCase_Reporting> GetListfirst(int Top, string strWhere, string filedOrder)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<Model.Reporting.R_LitigationCase_Reporting> GetAllList()
        {
        ...
        /// 分页获取数据列表
        /// </summary>
        public List<Model.Reporting.R_LitigationCase_Reporting> GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
