...
namespace BOC_BATCH_TOOL.EnumTypes
{
    public enum UILang
    {
    ...
    public enum AccountBankType
    {
        ...
        BocAccount = 0,
        [Description("其他银行")]
        [TranslatingKeyAttribute("Key1062", "其他银行", "Other banks", "其他銀行")]
        OtherBankAccount = 1
    }
    ...
    public enum AccountCategoryType
    {
        ...
        [Description("对公帐号")]
        [TranslatingKeyAttribute("Key1071", "对公帐号", "", "對公帳號")]
        Corperation = 0,

        [Description("对私帐号")]
        [TranslatingKeyAttribute("Key1072", "对私帐号", "", "對私帳號")]
        Personal = 4
    }
    ...
    public enum AgentExpressCertifyPaperType
    {
        ...
        //对私其它
        [TranslatingKeyAttribute("Key1110", "对私其他", "Personal, other", "對私其他")]
        PersonalOtherPaper = 11,

        //企业法人营业执照
        [TranslatingKeyAttribute("Key1111", "企业法人营业执照", "Corporate Business License", "企業法人營業執照")]
        CorperationDelegateLicense = 21,

        //企业营业执照
        [TranslatingKeyAttribute("Key1112", "企业营业执照", "Enterprise Business License", "企業營業執照")]
        CorperationOpertatingLicense = 22,

        //驻华机构登记证
        [TranslatingKeyAttribute("Key1113", "驻华机构登记证", "Registration certificate of foreign institution in China", "駐華機構登記證")]
        OrganizeInChinaRegisterPaper = 30,

        //个体工商户营业执照
        [TranslatingKeyAttribute("Key1114", "个体工商户营业执照", "Business license for individual economic establishment", "個體工商戶營業執照")]
        IndividualBusinessOperatingLicense = 31,

        //组织机构代码证
        [TranslatingKeyAttribute("Key1115", "组织机构代码证", "Organization code certificate", "組織機構代碼證")]
        OrganizeCodePaper = 33,

        //港澳居民来往内地通行证（香港）
        [TranslatingKeyAttribute("Key1116", "港澳居民来往内地通行证（香港）", "Hong Kong & Macau residents pass (Hong Kong)", "港澳台居民來往內地通行證(香港)")]
        HK_PeoplePassport = 47,

        //港澳居民来往内地通行证（澳门）
        [TranslatingKeyAttribute("Key1117", "港澳居民来往内地通行证（澳门）", "Hong Kong & Macau residents pass (Macau)", "港澳台居民來往內地通行證(澳門)")]
        MC_PeoplePassport = 48,

        //台湾居民来往大陆通行证    
        [TranslatingKeyAttribute("Key1118", "台湾居民来往大陆通行证", "Taiwan residents pass", "台灣居民來往大陸通行證")]
    ...
    //[Flags]
    public enum AppliableFunctionType
    {
        _Empty = 0,
    ...
    public enum ChinaProvinceType
    {
        ...
        B15 = 15,
        [TranslatingKeyAttribute("Key1307", "辽宁省", "Liaoning", "遼寧省")]
        B21 = 21,
        [TranslatingKeyAttribute("Key1308", "吉林省", "Jilin", "吉林省")]
        B22 = 22,
