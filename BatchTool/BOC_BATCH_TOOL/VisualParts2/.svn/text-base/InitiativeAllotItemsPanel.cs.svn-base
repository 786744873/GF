    ...
    public partial class InitiativeAllotItemsPanel : BaseUc
    {
        ...
        void CommandCenter_OnInitiativeAllotEventHandler(object sender, InitiativeAllotEventArgs e)
        {
            ...
            else
            {
                ...
                {
                    if (e.InitiativeAllotList.Count > SystemSettings.Instance.DefaultMaxCountInitiativeAllot)
                    {
                        ...
                        list = e.InitiativeAllotList.GetRange(0, SystemSettings.Instance.DefaultMaxCountInitiativeAllot);
                    }
                ...
                if(e.Command== OperatorCommandType.Submit
                    ...
                    CommandCenter.Instance.ResolveInitiativeAllot(OperatorCommandType.Reset, e.OwnerType);
        ...
        void CommandCenter_OnQueryByRowIndexEventHandler(object sender, QueryByRowIndexEventArgs e)
        {
            ...
            else
            {
                ...
                CommandCenter.Instance.ResolveInitiativeAllot(OperatorCommandType.View, (dgv.DataSource as List<InitiativeAllot>)[e.RowIndex], e.AppType, e.RowIndex);
            }
        }
        ...
        private void dgv_MouseDoubleClick(object sender, MouseEventArgs e)
        {
            ...
            CommandCenter.Instance.ResolveInitiativeAllot(OperatorCommandType.View, ae, m_AppType, hitInfo.RowIndex);
        }
