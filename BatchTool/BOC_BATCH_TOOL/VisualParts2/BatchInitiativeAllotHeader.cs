...
namespace BOC_BATCH_TOOL.VisualParts
{
    public partial class BatchInitiativeAllotHeader : BaseUc
    {
        ...
        private bool CheckData(bool flag)
        {
            ...
            {
                rd = DataCheckCenter.Instance.CheckCustomerNoInitiativeAllot(tbCustomerNo, tbCustomerNo.Text.Trim(), lbCustomNo.Text.Substring(0, lbCustomNo.Text.Length - 1), flag ? this.errorProvider1 : null);
            }
            else rd.Result = true;
            return rd.Result;
        }
