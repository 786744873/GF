...
namespace BOC_BATCH_TOOL.VisualParts
{
    public partial class SpplyFinancingOrderItemsPanel : BaseUc
    {
        ...
        void Init()
        {
            ...
            clnPayDate.HeaderText = m_AppType == AppliableFunctionType.PurchaserOrder ? MultiLanguageConvertHelper.Instance.SpplyFinancingOrder_PayDate_Seller : MultiLanguageConvertHelper.Instance.SpplyFinancingOrder_PayDate_Purchase;
        }
