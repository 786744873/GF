...
namespace BOC_BATCH_TOOL.VisualParts
{
    public partial class DataOperatePanel : BaseUc
    {
        ...
        {
            InitializeComponent();
            BOC_BATCH_TOOL.SysCoach.CommandCenter.Instance.OnLanguageChangedEventHandler += new EventHandler<SysCoach.LanguageChangedEventArgs>(Instance_OnLanguageChangedEventHandler);
        }
