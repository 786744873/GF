...
namespace BOC_BATCH_TOOL.VisualParts
{
    public partial class FileOperatePanel : BaseUc
    {
        ...
        {
            InitializeComponent();
            BOC_BATCH_TOOL.SysCoach.CommandCenter.Instance.OnLanguageChangedEventHandler += new EventHandler<SysCoach.LanguageChangedEventArgs>(CommandCenter_OnLanguageChangedEventHandler);
        }
