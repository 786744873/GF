...
namespace BOC_BATCH_TOOL.FileIO
{
    public class FileRWHelper
    {
        ...
        /// <returns></returns>
        public List<string> ReadCSVFieldsData(string filepath)
        {
        ...
        /// <param name="startRowIndex"></param>
        /// <returns></returns>
        public List<string> ReadExcelFieldsData(string filepath, int maxcount, int startRowIndex)
        {
            ...
            try
            {
                ...
                for (int i = startRowIndex; i <= maxcount + startRowIndex - 1; i++)
                {
                    ...
                    for (int j = 1; j < columncount; j++)
                    {
                        ...
                        temp.Append(((Excel.Range)sheet.Cells[i, j]).Formula.ToString() + SysCoach.SystemSettings.Instance.BOCSeparator);
                    }
        ...
        /// <param name="footer">文档尾信息</param>
        /// <returns></returns>
        public bool ExportDIFDocument(List<string> content, string filepath)
        {
            bool flag = false;
        ...
        public List<string> ReadDIFDocumnet(string filepath)
        {
            List<string> list = new List<string>();
            try
            {
        ...
        public bool ExportDATDocument(List<string> content, string filepath)
        {
            bool flag = false;
        ...
        public List<string> ReadDATDocument(string filepath)
        {
            List<string> list = new List<string>();
            try
            {
        ...
        private string GetFileInnerXml(string filepath)
        {
