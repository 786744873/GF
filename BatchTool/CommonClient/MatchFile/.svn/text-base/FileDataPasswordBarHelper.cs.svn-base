...
{
    public static class FileDataPasswordBarHelper
    {
        ...
        public static ResultData EncodeAndZip(string fromFile, string toFile, string password)
        {
        ...
        public static ResultData EncodeNoZip(string fromFile, string toFile, string password)
        {
            ResultData rd = new ResultData() { Result = true };
        ...
        public static ResultData DecodeAndUnzip(string fromFile, string toFile, string password)
        {
            ResultData rd = new ResultData { Result = true };
        ...
        public static ResultData DecodeNoUnzip(string fromFile, string toFile, string password)
        {
            ResultData rd = new ResultData { Result = true };
