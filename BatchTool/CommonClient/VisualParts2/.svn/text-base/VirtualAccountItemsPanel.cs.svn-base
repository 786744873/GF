...
namespace CommonClient.VisualParts2
{
    public partial class VirtualAccountItemsPanel : BaseUc
    {
        public VirtualAccountItemsPanel()
        {
            ...
            CommandCenter.OnVirtualAccountEventHandler += new EventHandler<VirtualAccountEventArgs>(CommandCenter_OnVirtualAccountEventHandler);
            dgv.MouseDoubleClick += new MouseEventHandler(dgv_MouseDoubleClick);
        }

        void CommandCenter_OnVirtualAccountEventHandler(object sender, VirtualAccountEventArgs e)
        {
            if (this.InvokeRequired) { this.Invoke(new EventHandler<VirtualAccountEventArgs>(CommandCenter_OnVirtualAccountEventHandler), sender, e); }
            else
            {
                ...
                {
                    if (e.VirtualAccountList.Count > SystemSettings.DefaultMaxCountInitiativeAllot)
                    {
                        ...
                        list = e.VirtualAccountList.GetRange(0, SystemSettings.DefaultMaxCountInitiativeAllot);
                    }
                ...
                else if (OperatorCommandType.DataMoveUp == e.Command || OperatorCommandType.DataMoveDown == e.Command)
                {
                    ...
                    VirtualAccount ae = list[selectedindex];
                ...
                if (e.Command == OperatorCommandType.Submit
                    ...
                    CommandCenter.ResolveVirtualAccount(OperatorCommandType.Reset, e.OwnerType);
        ...
        void CommandCenter_OnQueryByRowIndexEventHandler(object sender, QueryByRowIndexEventArgs e)
        {
            ...
            else
            {
                ...
                CommandCenter.ResolveVirtualAccount(OperatorCommandType.View, (dgv.DataSource as List<VirtualAccount>)[e.RowIndex], e.AppType, e.RowIndex);
            }
        }
        ...
        private void dgv_MouseDoubleClick(object sender, MouseEventArgs e)
        {
            ...
            CommandCenter.ResolveVirtualAccount(OperatorCommandType.View, ae, m_AppType, hitInfo.RowIndex);
        }
