...
namespace CommonClient.VisualParts2
{
    public partial class ElecTicketPoolOtherPanel : BaseUc
    {
        ...
        private void SetRegex()
        {
            ...
            tbPreBackNotedPerson.DvRegCode = "reg540";
            tbPreBackNotedPerson.DvMinLength = 0;
            tbPreBackNotedPerson.DvMaxLength = 120;
        ...
        public bool CheckData()
        {
            ...
            //{
            //    rd = DataCheckCenter.CheckPreBackNotedPerson(tbPreBackNotedPerson, tbPreBackNotedPerson.Text.Trim(), lbPreBackNotedPerson.Text.Substring(0, lbPreBackNotedPerson.Text.Length - 1), 120, this.errorProvider1);
