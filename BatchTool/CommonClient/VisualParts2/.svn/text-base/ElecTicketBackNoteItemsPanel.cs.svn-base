    ...
    public partial class ElecTicketBackNoteItemsPanel : BaseUc
    {
        ...
        void CommandCenter_OnElecTicketBackNoteEventHandler(object sender, ElecTicketBackNoteEventArgs e)
        {
            ...
            else
            {
                ...
                {
                    #region
                    if (e.ElecTicketBackNoteList.Count > SystemSettings.DefaultMaxCountElecTicket)
                    {
                        ...
                        list = e.ElecTicketBackNoteList.GetRange(0, SystemSettings.DefaultMaxCountElecTicket);
                    }
                ...
                else if (OperatorCommandType.DataMoveUp == e.Command || OperatorCommandType.DataMoveDown == e.Command)
                {
                    ...
                    ElecTicketBackNote ae = list[selectedindex];
                ...
                if (e.Command == OperatorCommandType.Submit
                    ...
                    CommandCenter.ResolveElecTicketBackNote(OperatorCommandType.Reset, e.OwnerType);
            }
        }
        ...
        void CommandCenter_OnQueryByRowIndexEventHandler(object sender, QueryByRowIndexEventArgs e)
        {
            ...
            else
            {
                ...
                CommandCenter.ResolveElecTicketBackNote(OperatorCommandType.View, (dgv.DataSource as List<ElecTicketBackNote>)[e.RowIndex], e.AppType, e.RowIndex);
            }
        }
        ...
        private void dgv_MouseDoubleClick(object sender, MouseEventArgs e)
        {
            ...
            if (null != etpm)
            {
                ...
                CommandCenter.ResolveElecTicketBackNote(OperatorCommandType.View, etpm, m_AppType, hitInfo.RowIndex);
            }
        }
