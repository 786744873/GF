...
namespace CommonClient.TemplateHelper
{
    public static class TemplateContentHelper
    {
        ...
        public static List<string> CreateContentInfo(AppliableFunctionType aft, IList<TransferAccount> dataList, string separatorChar)
        {
            ...
            foreach (var data in dataList)
            {
                ...
                if (aft == AppliableFunctionType.TransferWithIndiv || aft == AppliableFunctionType.TransferWithCorp)
                {
                    ...
                    content.Append((data.AccountBankType == AccountBankType.BocAccount ? 1 : 0) + separatorChar);//是否中行收款标志（必填。0-他行，1-中行）
        ...
        public static List<string> CreateContentInfo(AppliableFunctionType aft, IList<ElecTicketRemit> dataList, string separatorChar)
        {
            List<string> contentList = new List<string>();
        ...
        public static List<string> CreateContentInfo(AppliableFunctionType aft, IList<ElecTicketAutoTipExchange> dataList, string separatorChar)
        {
            List<string> contentList = new List<string>();
        ...
        public static List<string> CreateContentInfo(AppliableFunctionType aft, IList<ElecTicketPayMoney> dataList, string separatorChar)
        {
            List<string> contentList = new List<string>();
        ...
        public static List<string> CreateContentInfo(AppliableFunctionType aft, IList<ElecTicketBackNote> dataList, string separatorChar)
        {
            List<string> contentList = new List<string>();
        ...
        public static List<string> CreateContentInfo(AppliableFunctionType aft, IList<ElecTicketPool> dataList, string separatorChar)
        {
            List<string> contentList = new List<string>();
        ...
        public static List<string> CreateContentInfo(AppliableFunctionType aft, IList<TransferGlobal> dataList, string separatorChar)
        {
            List<string> contentList = new List<string>();
        ...
        public static List<string> CreateContentInfo(AppliableFunctionType aft, IList<UnitivePaymentRMB> dataList, string separatorChar)
        {
            List<string> contentList = new List<string>();
        ...
        public static List<string> CreateContentInfo(AppliableFunctionType aft, IList<SpplyFinancingApply> dataList, string separatorChar)
        {
            List<string> contentList = new List<string>();
            ...
            if (aft == AppliableFunctionType.ApplyofFranchiserFinancing)
            {
                ...
                foreach (var data in dataList)
                {
                    ...
                    content.Append("1,0" + Environment.NewLine);
                    content.Append(DataConvertHelper.FormatDateTimeFromInt(data.OrderDate) + Environment.NewLine);
                    content.Append("1,0" + Environment.NewLine);
                    ...
                    content.Append("1,0" + Environment.NewLine);
                    content.Append(DataConvertHelper.FormatDateTimeFromInt(data.DeliveryDate) + Environment.NewLine);
                    content.Append("1,0" + Environment.NewLine);
        ...
        public static List<string> CreateContentInfo(AppliableFunctionType aft, IList<SpplyFinancingOrder> dataList, string separatorChar)
        {
            List<string> contentList = new List<string>();
            ...
            foreach (var data in dataList)
            {
                ...
                if (aft == AppliableFunctionType.PurchaserOrder)
                {
                    ...
                    content.Append("1,0" + Environment.NewLine);
                    content.Append(DataConvertHelper.FormatDateTimeFromInt(data.PayDate) + Environment.NewLine);
                    content.Append("-1,0");
                }
        ...
        public static List<string> CreateContentInfo(AppliableFunctionType aft, IList<SpplyFinancingBill> dataList, string separatorChar)
        {
            List<string> contentList = new List<string>();
            ...
            foreach (var data in dataList)
            {
                    ...
                    || aft == AppliableFunctionType.BillofDebtReceivableSeller)
                {
                    ...
                    content.Append("V" + Environment.NewLine);
                    content.Append("1,0" + Environment.NewLine);
                    content.Append(DataConvertHelper.FormatDateTimeFromInt(data.BillDate) + Environment.NewLine);
                    content.Append("1,0" + Environment.NewLine);
                    content.Append(DataConvertHelper.FormatDateTimeFromInt(data.StartDate) + Environment.NewLine);
                    content.Append("1,0" + Environment.NewLine);
                    content.Append(DataConvertHelper.FormatDateTimeFromInt(data.EndDate) + Environment.NewLine);
                    content.Append("-1,0");
                }
        ...
        public static List<string> CreateContentInfo(AppliableFunctionType aft, IList<SpplyFinancingPayOrReceipt> dataList, string separatorChar)
        {
            List<string> contentList = new List<string>();
        ...
        public static List<string> CreateContentInfo(AppliableFunctionType aft, IList<AgentExpress> dataList, BatchHeader batch, string separatorChar, double amount)
        {
            List<string> contentList = new List<string>();
            #region 批信息
            #region
            ...
            foreach (var data in dataList)
            {
                ...
                if (batch.BankType == AgentTransferBankType.Boc)
                    content.Append((data.Province != ChinaProvinceType.B0 ? ((int)data.Province).ToString() : string.Empty) + separatorChar);
        ...
        public static List<string> CreateContentInfo(AppliableFunctionType aft, IList<AgentNormal> dataList, BatchHeader batch, string separatorChar, double amount)
        {
            List<string> contentList = new List<string>();
            #region 批信息
            #region
        ...
        public static List<string> CreateContentInfo(AppliableFunctionType aft, IList<InitiativeAllot> dataList, BatchHeader batch, string separatorChar, double amount)
        {
            List<string> contentList = new List<string>();
            #region 批信息
            #region
        ...
        public static List<string> CreateContentInfo(FunctionInSettingType fst, IList<PayeeInfo> dataList, string separatorChar)
        {
            List<string> contentList = new List<string>();
            ...
            foreach (var data in dataList)
            {
                ...
                if (fst == FunctionInSettingType.PayeeMg)
                {
                    ...
                    if (data.CertifyPaperType == PayeeCertifyPaperType.Empty)//证件类型	11		非必填
                        content.Append(separatorChar);
                    else
                    {
                        if ((SystemSettings.CurrentVersion & VersionType.v501) == VersionType.v501)
                            content.Append(((int)data.CertifyPaperType).ToString() + separatorChar);
                        else
                            content.Append(((int)data.CertifyPaperType).ToString().PadLeft(2, '0') + separatorChar);
                    }
        ...
        public static List<string> CreateContentInfo(FunctionInSettingType fst, IList<ElecTicketRelationAccount> dataList, string separatorChar)
        {
            List<string> contentList = new List<string>();
        ...
        public static List<string> CreateContentInfo(FunctionInSettingType fst, IList<PayeeInfo4TransferGlobal> dataList, string separatorChar)
        {
            List<string> contentList = new List<string>();
        ...
        public static List<string> CreateContentInfoBar(AppliableFunctionType aft, IList<TransferGlobal> dataList, string separactorChar)
        {
            List<string> contentList = new List<string>();
            foreach (var data in dataList)
            {
                ...
                else if (aft == AppliableFunctionType.TransferForeignMoney4Bar)
                {
                    if (data.PayeeOpenBankType == AccountBankType.BocAccount)
                    {
                        ...
                        content.Append((!string.IsNullOrEmpty(data.Bar_Addition) ? data.Bar_Addition : string.Empty).PadRight(80 - GetByteLength(data.Bar_Addition) + (!string.IsNullOrEmpty(data.Bar_Addition) ? data.Bar_Addition.Length : 0), ' '));
                        ...
                        content.Append((data.AgentFunctionType_Express != AgentExpressFunctionType.Empty ? data.AgentFunctionType_Express.ToString() : string.Empty).PadRight(2, ' '));
                        content.Append(string.Empty.PadRight(5 + 80 + 100, ' '));
                        content.Append(separactorChar);
                        #endregion
                    }
                    else
                    {
                        ...
                        content.Append(data.PaymentPropertyType != PaymentPropertyType.Empty ? DataConvertHelper.GetPaymentPropertyTypeBarValue(data.PaymentPropertyType) : string.Empty.PadLeft(1, ' '));
                        content.Append((!string.IsNullOrEmpty(data.DealSerialNoF) ? data.DealSerialNoF.Trim() : string.Empty).PadRight(6, ' '));
        ...
        public static List<string> CreateContentInfoBar(AppliableFunctionType aft, IList<AgentExpress> dataList, AgentTransferBankType bankType, string separactorChar)
        {
            List<string> contentList = new List<string>();
            foreach (var data in dataList)
            {
        ...
        public static List<string> CreateContentInfo(AppliableFunctionType aft, IList<UnitivePaymentForeignMoney> dataList, string separatorChar, OverCountryPayeeAccountType type)
        {
            List<string> contentList = new List<string>();
            ...
            foreach (var data in dataList)
            {
                ...
                switch (type)
                {
                    case OverCountryPayeeAccountType.BocAccount:
                        ...
                        content.Append((data.PaymentNature != PaymentPropertyType.Empty ? ((int)data.PaymentNature).ToString() : string.Empty) + separatorChar);
                    ...
                    case OverCountryPayeeAccountType.OtherAccount:
                        ...
                        content.Append(data.ApplicantName + separatorChar);
                        content.Append(data.Contactnumber + separatorChar);
                        content.Append((data.AssumeFeeType != AssumeFeeType.Empty ? data.AssumeFeeType.ToString() : string.Empty).PadRight(1, ' '));
                        #endregion
                        break;
                    case OverCountryPayeeAccountType.ForeignAccount:
                        ...
                        content.Append(data.ApplicantName + separatorChar);
                        content.Append(data.Contactnumber + separatorChar);
                        content.Append(data.NominalPayerAddress + separatorChar);
                        content.Append((data.AssumeFeeType != AssumeFeeType.Empty ? data.AssumeFeeType.ToString() : string.Empty).PadRight(1, ' '));
                        #endregion
                        break;
                }
        ...
        public static List<string> CreateContentInfo(AppliableFunctionType aft, IList<VirtualAccount> dataList, string separatorChar)
        {
            List<string> contentList = new List<string>();
            ...
            foreach (var data in dataList)
            {
                ...
                if (aft == AppliableFunctionType.VirtualAccountTransfer)
                {
                    ...
                    content.Append(data.AccountIn + separatorChar);
                    content.Append(data.NameIn + separatorChar);
                    content.Append((data.CashType != CashType.Empty ? data.CashType.ToString() : string.Empty) + separatorChar);
                    content.Append(data.Amount + separatorChar);
                    content.Append(data.Purpose + separatorChar);
                    content.Append(data.CustomerBusinissNo + separatorChar);
                    contentList.Add(content.ToString());
        ...
        public static List<string> CreateContentInfo(AppliableFunctionType aft, IList<PreproccessTransfer> dataList, string separatorChar)
        {
            List<string> contentList = new List<string>();
            ...
            foreach (var data in dataList)
            {
                ...
                {
                    content.Append(data.PreproccessName + separatorChar);
                    content.Append(data.PreproccessAccount + separatorChar);
                    content.Append((data.CashType == CashType.Empty ? string.Empty : data.CashType.ToString()) + separatorChar);
                    content.Append(data.PreproccessAmount + separatorChar);
                    content.Append(data.MainAccount + separatorChar);
                    content.Append(data.TradeSerialNo + separatorChar);
                    content.Append(data.BatchTradeSerialNo + separatorChar);
                    content.Append(data.InvolvedName + separatorChar);
                    content.Append(data.InvolvedAccount + separatorChar);
                    content.Append(data.TradeDate + separatorChar);
                    content.Append(data.Content + separatorChar);
                    content.Append(data.VirtualAccount + separatorChar);
                    content.Append(data.Amount + separatorChar);
                    contentList.Add(content.ToString());
                }
            }
        ...
        public static List<string> CreateContentInfo(AppliableFunctionType aft, IList<BatchReimbursement> dataList, string separatorChar)
        {
            List<string> contentList = new List<string>();
            ...
            foreach (var data in dataList)
            {
                ...
                {
                    content.Append(data.CardNo + separatorChar);
                    content.Append(data.PayAmount + separatorChar);
                    content.Append(data.PayDateTime + separatorChar);
                    content.Append(data.PayPassword + separatorChar);
                    content.Append(data.ReimburseAmount + separatorChar);
                    content.Append(data.Usage + separatorChar);
                    contentList.Add(content.ToString());
                }
            }
            return contentList;
        ...
        public static List<string> CreateContentInfo(AppliableFunctionType aft, IList<GovermentInfo> dataList, string separatorChar)
        {
            List<string> contentList = new List<string>();
            ...
            foreach (var data in dataList)
            {
                ...
                content.Append(data.PayerAccount + separatorChar);
                content.Append(data.PayeeAccount + separatorChar);
                content.Append(data.PayeeOpenBank + separatorChar);
                content.Append(data.PayeeName + separatorChar);
                content.Append(data.PayAmount + separatorChar);
                content.Append(data.PayDatetime + separatorChar);
                content.Append(data.Addition + separatorChar);
                content.Append(data.PayeeCode + separatorChar);
                content.Append(data.OddNumber + separatorChar);
                content.Append((data.AccountBankType == AccountBankType.BocAccount ? 1 : 0) + separatorChar);
                content.Append(data.CNAPSNo + separatorChar);
                contentList.Add(content.ToString());
            }
            return contentList;
        }
        ...
        public static List<TransferAccount> GetTransferAccount(List<string> contentData, AppliableFunctionType templateType)
        {
            List<TransferAccount> list = new List<TransferAccount>();

            int maxcount = SystemSettings.BatchMappingSettings[templateType].MaxCountPerOperation;
            if (maxcount == 0) maxcount = CommonInformations.GetFunctionMaximum(templateType);
            string[] s = new string[] { SystemSettings.BatchMappingSettings[templateType].SeperateChar };
            int count = 0;
            TransferAccount ta;
            ...
            foreach (var data in contentData)
            {
                ...
                catch { ta.ErrorReason = MultiLanguageConvertHelper.DesignMain_InvalidDta_ChangeFile_Fail; }
                finally
                {
                    list.Add(ta);
                    count++;
        ...
        public static List<TransferAccount> GetTransferAccountBOC(List<string> contentData, AppliableFunctionType templateType)
        {
            List<TransferAccount> list = new List<TransferAccount>();

            int maxcount = SystemSettings.BatchMappingSettings[templateType].MaxCountPerOperation;
            if (maxcount == 0) maxcount = CommonInformations.GetFunctionMaximum(templateType);
            string[] s = new string[] { SystemSettings.BOCSeparator };
            int count = 0;
            TransferAccount ta;
            ...
            foreach (var data in contentData)
            {
                ...
                try
                {
                    ...
                    if (!string.IsNullOrEmpty(strList[13]))
                        ta.PayDatetime = strList[13];
                    //else if (string.IsNullOrEmpty(ta.ErrorReason))
                    //    ta.ErrorReason = "指定付款日期为空";
                    if (!string.IsNullOrEmpty(strList[14]))
                        ta.Addition = strList[14];
                    if (!string.IsNullOrEmpty(strList[15]))
                        ta.TChanel = DataConvertHelper.GetTransferChanelType(strList[15]);
                    if (!string.IsNullOrEmpty(strList[16]))
                        ta.Email = strList[16];
                    if (!string.IsNullOrEmpty(strList[19]))
                    {
                        try
                        {
                            ta.AccountBankType = DataConvertHelper.GetAccountBankTypeObject((int.Parse(strList[19]) + 1) % 2);
                        }
                        catch { }
                    }
                    //else if (string.IsNullOrEmpty(ta.ErrorReason))
        ...
        public static List<TransferAccount> GetTransferAccountBOCErrorLog(List<string> contentData, AppliableFunctionType templateType)
        {
            List<TransferAccount> list = new List<TransferAccount>();
            ...
            {
                ta = new TransferAccount();
                string[] strList = AnalyseBOCCSVSytleData(data);
                try
                {
        ...
        public static List<GovermentInfo> GetGovermentBOCErrorLog(List<string> contentData, AppliableFunctionType templateType)
        {
        ...
        public static List<object> GetAgentExpress(List<string> contentData, AppliableFunctionType templateType)
        {
            ...
            foreach (var data in contentData)
            {
                ...
                if (count == 0)
                {
                    ...
                    batch.AgentFunctionType_Express = DataConvertHelper.GetAgentExpressFunctionType(strList[7]);
                ...
                try
                {
                    ...
                    if (AppliableFunctionType.AgentExpressIn == templateType)
                    {
                        ...
                        ae.UsageType = DataConvertHelper.GetAgentExpressFunctionType(strList[7]);
                    }
                    else if (AppliableFunctionType.AgentExpressOut == templateType)
                        ae.UsageType = DataConvertHelper.GetAgentExpressFunctionType(strList[6]);
                }
        ...
        public static List<object> GetAgentExpressBOC(List<string> contentData, AppliableFunctionType templateType)
        {
            List<object> result = new List<object>();
            BatchHeader batch = new BatchHeader();
            List<AgentExpress> list = new List<AgentExpress>();
            ...
            foreach (var data in contentData)
            {
                ...
                if (count == 0)
                {
                    ...
                    if (AppliableFunctionType.AgentExpressIn == templateType)
                    {
                        ...
                        batch.TransferDatetime = DateTime.Parse(DataConvertHelper.FormatDateTimeFromInt(strList[6]));
                        batch.Addtion = strList[7];
                    }
                    try
                    {
                        if (AppliableFunctionType.AgentExpressOut == templateType)
                        {
                            ...
                            batch.UseType = strList[7];
                            batch.TransferDatetime = DateTime.Parse(DataConvertHelper.FormatDateTimeFromInt(strList[8]));
                            batch.Addtion = strList[9];
                        }
                    }
                    catch { };
                    batch.AgentFunctionType_Express = DataConvertHelper.GetAgentExpressFunctionType(batch.UseType);
                ...
                try
                {
                    ...
                    if (!string.IsNullOrEmpty(strList[0]))
                    {
                        ...
                        if (batch.BankType == AgentTransferBankType.Boc)
                            ae.Province = DataConvertHelper.GetProvince(strList[0]);
        ...
        public static List<object> GetAgentExpressBOCErrorLog(List<string> contentData, AppliableFunctionType templateType)
        {
            List<object> result = new List<object>();
            BatchHeader batch = new BatchHeader();
            List<AgentExpress> list = new List<AgentExpress>();
        ...
        public static List<object> GetAgentNormal(List<string> contentData, AppliableFunctionType templateType)
        {
            List<object> result = new List<object>();
            BatchHeader batch = new BatchHeader();
        ...
        public static List<object> GetAgentNormalBOC(List<string> contentData, AppliableFunctionType templateType)
        {
            List<object> result = new List<object>();
            BatchHeader batch = new BatchHeader();
            List<AgentNormal> list = new List<AgentNormal>();
            ...
            foreach (var data in contentData)
            {
                ...
                if (count == 0)
                {
                    ...
                    if (templateType == AppliableFunctionType.AgentNormalIn)
                    {
                        ...
                        try
                        {
                            batch.TransferDatetime = DateTime.Parse(DataConvertHelper.FormatDateTimeFromInt(strList[9]));
                        }
                        catch { }
                        batch.Addtion = strList[10];
                    }
                ...
                try
                {
                    ...
                    if (!string.IsNullOrEmpty(strList[6]))
                        an.CertifyPaperType = DataConvertHelper.GetAgentNormalCertifyPaperType(strList[6]);
                    an.CertifyPaperNo = strList[7];
                    if (templateType == AppliableFunctionType.AgentNormalOut)
                    {
                        try
        ...
        public static List<object> GetAgentNormalBOCErrorLog(List<string> contentData, AppliableFunctionType templateType)
        {
            List<object> result = new List<object>();
            BatchHeader batch = new BatchHeader();
            List<AgentNormal> list = new List<AgentNormal>();
        ...
        public static List<TransferAccount> GetTransferOverBank(List<string> contentData, AppliableFunctionType templateType)
        {
            List<TransferAccount> list = new List<TransferAccount>();
        ...
        public static List<TransferAccount> GetTransferOverBankBOC(List<string> contentData, AppliableFunctionType templateType)
        {
            List<TransferAccount> list = new List<TransferAccount>();
            ...
            foreach (var data in contentData)
            {
                ...
                try
                {
                    if (templateType == AppliableFunctionType.TransferOverBankIn)
                    {
                        ...
                        //    ta.ErrorReason = "协议号为空";
                        if (!string.IsNullOrEmpty(strList[8]))
                            ta.BusinessType = DataConvertHelper.GetBusinessType(strList[8]);
                        //else if (string.IsNullOrEmpty(ta.ErrorReason))
                        //    ta.ErrorReason = "业务种类为空";
                        if (!string.IsNullOrEmpty(strList[9]))
                            ta.PayFeeNo = strList[9];
        ...
        public static List<TransferAccount> GetTransferOverBankBOCErrorLog(List<string> contentData, AppliableFunctionType templateType)
        {
            List<TransferAccount> list = new List<TransferAccount>();
        ...
        public static List<PayeeInfo> GetPayee(List<string> contentData, FunctionInSettingType fst)
        {
            List<PayeeInfo> list = new List<PayeeInfo>();

            int maxcount = SystemSettings.DefaultMaxCountPayeeMgr;
            string[] s = new string[] { SystemSettings.BOCSeparator };
            int count = 0;
            PayeeInfo payee;
            ...
            foreach (var data in contentData)
            {
                ...
                try
                {
                    if (fst == FunctionInSettingType.PayeeMg)
                    {
                        ...
                        if (!string.IsNullOrEmpty(strList[9]))
                            payee.CertifyPaperType = (PayeeCertifyPaperType)(int.Parse(strList[9]));
                        if (!string.IsNullOrEmpty(strList[10]))
                    ...
                    else if (fst == FunctionInSettingType.AgentExpressInPayerMg)
                    {
                        ...
                        if (!string.IsNullOrEmpty(strList[6]))
                            payee.AccountType = (AccountCategoryType)(int.Parse(strList[6]));
                        if (!string.IsNullOrEmpty(strList[7]))
                            payee.CertifyPaperType = (PayeeCertifyPaperType)(int.Parse(strList[7]));
                        if (!string.IsNullOrEmpty(strList[8]))
                ...
                catch { throw new Exception(MultiLanguageConvertHelper.DesignMain_InvalidDta_ChangeFile_Fail); }
                finally { count++; }
                list.Add(payee);
            }
        ...
        public static List<ElecTicketRelationAccount> GetElecTicketRelateAccount(List<string> contentData, bool flag)
        {
            ...
            foreach (var data in contentData)
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        if (!string.IsNullOrEmpty(strList[5]))
                            payee.PersonType = DataConvertHelper.GetRelatePersonType(strList[5]);
                        if (!string.IsNullOrEmpty(strList[6]))
                            payee.Tel_First = strList[6];
                        if (!string.IsNullOrEmpty(strList[7]))
                            payee.Email_First = strList[7];
        ...
        public static List<PayeeInfo4TransferGlobal> GetPayeeInfo4TransferGlobal(List<string> contentData, bool flag)
        {
        ...
        public static List<ElecTicketRemit> GetElecTicketRemit(List<string> contentData, AppliableFunctionType templateType)
        {
            ...
            foreach (var data in contentData)
            {
                ...
                {
                    if (!string.IsNullOrEmpty(strList[0]))
                        ta.TicketType = DataConvertHelper.GetElecTicketType(strList[0], templateType);
                    if (!string.IsNullOrEmpty(strList[1]))
                        ta.Amount = strList[1].Replace(",", "");
                    if (!string.IsNullOrEmpty(strList[2]))
                        ta.RemitDate = DataConvertHelper.FormatDateTimeFromInt(strList[2]);
                    if (!string.IsNullOrEmpty(strList[3]))
                        ta.EndDate = DataConvertHelper.FormatDateTimeFromInt(strList[3]);
                    if (!string.IsNullOrEmpty(strList[4]))
                    ...
                    if (!string.IsNullOrEmpty(strList[13]))
                        ta.CanChange = DataConvertHelper.GetCanChangeType(strList[13]);
                    if (!string.IsNullOrEmpty(strList[14]))
        ...
        public static List<ElecTicketRemit> GetElecTicketRemitBOC(List<string> contentData, AppliableFunctionType templateType)
        {
            List<ElecTicketRemit> list = new List<ElecTicketRemit>();
        ...
        public static List<ElecTicketRemit> GetElecTicketRemitBOCErrorLog(List<string> contentData, AppliableFunctionType templateType)
        {
            List<ElecTicketRemit> list = new List<ElecTicketRemit>();
        ...
        public static List<ElecTicketBackNote> GetElecTicketBackNote(List<string> contentData, AppliableFunctionType templateType)
        {
        ...
        public static List<ElecTicketBackNote> GetElecTicketBackNoteBOC(List<string> contentData, AppliableFunctionType templateType)
        {
            List<ElecTicketBackNote> list = new List<ElecTicketBackNote>();
        ...
        public static List<ElecTicketBackNote> GetElecTicketBackNoteBOCErrorLog(List<string> contentData, AppliableFunctionType templateType)
        {
            List<ElecTicketBackNote> list = new List<ElecTicketBackNote>();
        ...
        public static List<ElecTicketAutoTipExchange> GetElecTicketAutoTipExchange(List<string> contentData, AppliableFunctionType templateType)
        {
            ...
            foreach (var data in contentData)
            {
                ...
                try
                {
                    ...
                    if (!string.IsNullOrEmpty(strList[6]))
                        ta.BillSerialNo = strList[6];
                    if (!string.IsNullOrEmpty(strList[7]))
                        ta.ContractNo = strList[7];
                    if (!string.IsNullOrEmpty(strList[8]))
                        ta.Note = strList[8];
                }
                catch { /*ta.ErrorReason = MultiLanguageConvertHelper.DesignMain_InvalidDta_ChangeFile_Fail; */}
        ...
        public static List<ElecTicketAutoTipExchange> GetElecTicketAutoTipExchangeBOC(List<string> contentData, AppliableFunctionType templateType)
        {
            List<ElecTicketAutoTipExchange> list = new List<ElecTicketAutoTipExchange>();
        ...
        public static List<ElecTicketAutoTipExchange> GetElecTicketAutoTipExchangeBOCErrorLog(List<string> contentData, AppliableFunctionType templateType)
        {
            List<ElecTicketAutoTipExchange> list = new List<ElecTicketAutoTipExchange>();
        ...
        public static List<ElecTicketPayMoney> GetElecTicketPayMoney(List<string> contentData, AppliableFunctionType templateType)
        {
            ...
            foreach (var data in contentData)
            {
                ...
                try
                {
                    ...
                    if (!string.IsNullOrEmpty(strList[5]))
                        ta.ClearType = DataConvertHelper.GetClearType(strList[5]);
                    //else if (string.IsNullOrEmpty(ta.ErrorReason))
                    //    ta.ErrorReason = "清算方式为空";
                    if (!string.IsNullOrEmpty(strList[4]))
                        ta.ProtocolMoneyType = DataConvertHelper.GetProtocolMoneyType(strList[3]);
                    if (!string.IsNullOrEmpty(strList[6]))
                        ta.PayMoneyDate = DataConvertHelper.FormatDateTimeFromInt(strList[6]);
                    //else if (string.IsNullOrEmpty(ta.ErrorReason))
                    ...
                    if (!string.IsNullOrEmpty(strList[15]))
                        ta.BillSerialNo = strList[15];
                    if (!string.IsNullOrEmpty(strList[16]))
                        ta.ContractNo = strList[16];
        ...
        public static List<ElecTicketPayMoney> GetElecTicketPayMoneyBOC(List<string> contentData, AppliableFunctionType templateType)
        {
            List<ElecTicketPayMoney> list = new List<ElecTicketPayMoney>();
        ...
        public static List<ElecTicketPayMoney> GetElecTicketPayMoneyBOCErrorLog(List<string> contentData, AppliableFunctionType templateType)
        {
            List<ElecTicketPayMoney> list = new List<ElecTicketPayMoney>();
        ...
        public static List<ElecTicketPool> GetElecTicketPool(List<string> contentData, AppliableFunctionType templateType)
        {
            ...
            foreach (var data in contentData)
            {
                ...
                try
                {
                    if (!string.IsNullOrEmpty(strList[0]))
                        ta.CustomerRef = strList[0];
                    if (!string.IsNullOrEmpty(strList[1]))
                        ta.ElecTicketType = DataConvertHelper.GetElecTicketType(strList[1], templateType);
                    if (!string.IsNullOrEmpty(strList[2]))
                        ta.BankType = DataConvertHelper.GetAccountBankTypeObject(strList[2], templateType);
                    if (!string.IsNullOrEmpty(strList[3]))
                        ta.ElecTicketSerialNo = strList[3];
                    if (!string.IsNullOrEmpty(strList[4]))
                        ta.Amount = DataConvertHelper.FormatCash(strList[4], false);
                    if (!string.IsNullOrEmpty(strList[5]))
                    ...
                    if (!string.IsNullOrEmpty(strList[18]))
                        ta.EndDateOperate = DataConvertHelper.GetEndDateOperateType(strList[18]);
                    if (!string.IsNullOrEmpty(strList[19]))
                        ta.BusinessType = DataConvertHelper.GetElecTicketPoolBusinessType(strList[19]);
                }
                catch { /*ta.ErrorReason = MultiLanguageConvertHelper.DesignMain_InvalidDta_ChangeFile_Fail; */}
                finally
                {
        ...
        public static List<ElecTicketPool> GetElecTicketPoolBOC(List<string> contentData, AppliableFunctionType templateType)
        {
            List<ElecTicketPool> list = new List<ElecTicketPool>();
            ...
            foreach (var data in contentData)
            {
                ...
                try
                {
                    ...
                    if (!string.IsNullOrEmpty(strList[4]))
                        ta.Amount = DataConvertHelper.FormatCash(strList[4], false);
                    if (!string.IsNullOrEmpty(strList[5]))
                        ta.RemitDate = DataConvertHelper.FormatDateTimeFromInt(strList[5]);
                    if (!string.IsNullOrEmpty(strList[6]))
                        ta.EndDate = DataConvertHelper.FormatDateTimeFromInt(strList[6]);
                    if (!string.IsNullOrEmpty(strList[7]))
                        ta.RemitName = strList[7];
                    if (!string.IsNullOrEmpty(strList[8]))
                        ta.RemitAccount = strList[8];
                    ...
                    if (!string.IsNullOrEmpty(strList[11]))
                        ta.ExchangeBankNo = strList[11];
                    if (!string.IsNullOrEmpty(strList[12]))
                        ta.ExchangeDate = DataConvertHelper.FormatDateTimeFromInt(strList[12]);
                    if (!string.IsNullOrEmpty(strList[13]))
                        ta.PayeeName = strList[13];
                    if (!string.IsNullOrEmpty(strList[14]))
                        ta.PayeeAccount = strList[14];
        ...
        public static List<ElecTicketPool> GetElecTicketPoolBOCErrorLog(List<string> contentData, AppliableFunctionType templateType)
        {
            List<ElecTicketPool> list = new List<ElecTicketPool>();
        ...
        public static List<TransferGlobal> GetTransferGlobal(List<string> contentData, AppliableFunctionType templateType)
        {
                ...
                try
                {
                    ...
                    if (templateType == AppliableFunctionType.TransferOverCountry)
                    {
                        ...
                        if (!string.IsNullOrEmpty(strList[2]))
                            ta.PaymentType = "电汇";
                        if (!string.IsNullOrEmpty(strList[3]))
                            ta.SendPriority = DataConvertHelper.GetTransferChanelType(strList[3]);
                        if (!string.IsNullOrEmpty(strList[4]))
                            ta.PaymentCashType = DataConvertHelper.GetCashType(strList[4]);
                        if (!string.IsNullOrEmpty(strList[5]))
                            ta.RemitAmount = DataConvertHelper.FormatCash(strList[5], false);
                        if (!string.IsNullOrEmpty(strList[6]))
                            ta.SpotAccount = strList[6];
                        if (!string.IsNullOrEmpty(strList[7]))
                            ta.SpotAmount = DataConvertHelper.FormatCash(strList[7], false);
                        if (!string.IsNullOrEmpty(strList[8]))
                            ta.PurchaseAccount = strList[8];
                        if (!string.IsNullOrEmpty(strList[9]))
                            ta.PurchaseAmount = DataConvertHelper.FormatCash(strList[9], false);
                        if (!string.IsNullOrEmpty(strList[10]))
                            ta.OtherAccount = strList[10];
                        if (!string.IsNullOrEmpty(strList[11]))
                            ta.OtherAmount = DataConvertHelper.FormatCash(strList[11], false);
                        if (!string.IsNullOrEmpty(strList[12]))
                        ...
                        if (!string.IsNullOrEmpty(strList[25]))
                            ta.AssumeFeeType = DataConvertHelper.GetAssumeFeeType(strList[25]);
                        ...
                        if (!string.IsNullOrEmpty(strList[28]))
                            ta.PayFeeType = DataConvertHelper.GetPayFeeType(strList[28]);
                        if (!string.IsNullOrEmpty(strList[29]))
                            ta.DealSerialNoF = strList[29];
                        if (!string.IsNullOrEmpty(strList[30]))
                            ta.AmountF = DataConvertHelper.FormatCash(strList[30], false);
                        ...
                        if (!string.IsNullOrEmpty(strList[33]))
                            ta.AmountS = DataConvertHelper.FormatCash(strList[33], false);
                        if (!string.IsNullOrEmpty(strList[34]))
                            ta.DealNoteS = strList[34];
                        if (!string.IsNullOrEmpty(strList[35]))
                            ta.IsPayOffLine = DataConvertHelper.GetIsPayOffLine(strList[35]);
                    ...
                    else if (templateType == AppliableFunctionType.TransferForeignMoney)
                    {
                        ...
                        if (!string.IsNullOrEmpty(strList[26]))
                            ta.AssumeFeeType = DataConvertHelper.GetAssumeFeeType(strList[26]);
                        if (!string.IsNullOrEmpty(strList[27]))
                            ta.PayeeCodeofCountry = strList[27];
                        if (!string.IsNullOrEmpty(strList[28]))
                            ta.PayeeNameofCountry = strList[28];
                        if (!string.IsNullOrEmpty(strList[29]))
                            ta.PayFeeType = DataConvertHelper.GetPayFeeType(strList[29]);
                        if (!string.IsNullOrEmpty(strList[30]))
                            ta.PaymentPropertyType = DataConvertHelper.GetPaymentPropertyType(strList[30]);
                        if (!string.IsNullOrEmpty(strList[31]))
                            ta.DealSerialNoF = strList[31];
                        if (!string.IsNullOrEmpty(strList[32]))
                            ta.AmountF = DataConvertHelper.FormatCash(strList[32], false);
                        if (!string.IsNullOrEmpty(strList[33]))
                            ta.DealSerialNoS = strList[33];
                        if (!string.IsNullOrEmpty(strList[34]))
                            ta.AmountS = DataConvertHelper.FormatCash(strList[34], false);
                        if (!string.IsNullOrEmpty(strList[35]))
                            ta.IsPayOffLine = DataConvertHelper.GetIsPayOffLine(strList[35]);
                        if (!string.IsNullOrEmpty(strList[36]))
                            ta.ContactNo = strList[36];
                    ...
                    if (!string.IsNullOrEmpty(ta.RemitAmount)) ta.RemitAmount = DataConvertHelper.FormatCash(ta.RemitAmount, ta.PaymentCashType == CashType.JPY);
                    if (!string.IsNullOrEmpty(ta.SpotAmount)) ta.SpotAmount = DataConvertHelper.FormatCash(ta.SpotAmount, ta.PaymentCashType == CashType.JPY);
                    if (!string.IsNullOrEmpty(ta.PurchaseAmount)) ta.PurchaseAmount = DataConvertHelper.FormatCash(ta.PurchaseAmount, ta.PaymentCashType == CashType.JPY);
                    if (!string.IsNullOrEmpty(ta.OtherAmount)) ta.OtherAmount = DataConvertHelper.FormatCash(ta.OtherAmount, ta.PaymentCashType == CashType.JPY);
                    if (!string.IsNullOrEmpty(ta.AmountF)) ta.AmountF = DataConvertHelper.FormatCash(ta.AmountF, ta.PaymentCashType == CashType.JPY);
                    if (!string.IsNullOrEmpty(ta.AmountS)) ta.AmountS = DataConvertHelper.FormatCash(ta.AmountS, ta.PaymentCashType == CashType.JPY);
                    #endregion
                }
                catch { ta.ErrorReason = MultiLanguageConvertHelper.DesignMain_InvalidDta_ChangeFile_Fail; }
                finally
        ...
        public static List<TransferGlobal> GetTransferGlobalBOC(List<string> contentData, AppliableFunctionType templateType)
        {
            List<TransferGlobal> list = new List<TransferGlobal>();
        ...
        public static List<TransferGlobal> GetTransferGlobalBOCErrorLog(List<string> contentData, AppliableFunctionType templateType)
        {
            List<TransferGlobal> list = new List<TransferGlobal>();
        ...
        public static List<SpplyFinancingApply> GetSpplyFinancingApply(List<List<string>> contentData, AppliableFunctionType templateType)
        {
            ...
            foreach (var data in contentData)
            {
                ...
                try
                {
                    ...
                    if (!string.IsNullOrEmpty(data[1]))
                        sfa.OrderDate = DateTime.Parse(DataConvertHelper.FormatDateTimeFromInt(data[1])).ToString("yyyy/MM/dd");
                    if (!string.IsNullOrEmpty(data[2]))
                        sfa.ContractOrOrderCashType = DataConvertHelper.GetCashType(data[2]);
                    if (!string.IsNullOrEmpty(data[3]))
                        sfa.ContractOrOrderAmount = DataConvertHelper.FormatNum(data[3]);
                    if (!string.IsNullOrEmpty(data[4]))
                        sfa.DeliveryDate = DateTime.Parse(DataConvertHelper.FormatDateTimeFromInt(data[4])).ToString("yyyy/MM/dd");
                    if (!string.IsNullOrEmpty(data[5]))
                        sfa.SettlementType = DataConvertHelper.GetSettlementType(data[5]);
                    ...
                    if (!string.IsNullOrEmpty(data[10]))
                        sfa.ApplyAmount = DataConvertHelper.FormatNum(data[10]);
                    if (!string.IsNullOrEmpty(data[11]))
                        sfa.ApplyDays = int.Parse(DataConvertHelper.FormatNum(data[11]));
                    if (!string.IsNullOrEmpty(data[12]))
                        sfa.AgreementNo = data[12];
                    if (!string.IsNullOrEmpty(data[13]))
                        sfa.InterestFloatType = DataConvertHelper.GetInterestFloatType(data[13]);
        ...
        public static List<SpplyFinancingApply> GetSpplyFinancingApplyBOC(List<List<string>> contentData, AppliableFunctionType templateType)
        {
            List<SpplyFinancingApply> list = new List<SpplyFinancingApply>();

            int maxcount = CommonInformations.GetFunctionMaximum(templateType);
            string[] s = new string[] { SystemSettings.BOCSeparator };
            int count = 0;
            SpplyFinancingApply sfa;
        ...
        public static List<SpplyFinancingOrder> GetSpplyFinancingOrder(List<List<string>> contentData, AppliableFunctionType templateType)
        {
                ...
                try
                {
                    ...
                    if (templateType == AppliableFunctionType.PurchaserOrder)
                    {
                        if (!string.IsNullOrEmpty(data[0]))
                            sfo.OrderNo = data[0];
                        if (!string.IsNullOrEmpty(data[1]))
                            sfo.CashType = DataConvertHelper.GetCashType(data[1]);
                        if (!string.IsNullOrEmpty(data[2]))
                            sfo.Amount = DataConvertHelper.FormatNum(data[2]);
                        if (!string.IsNullOrEmpty(data[3]))
                            sfo.ERPCode = data[3];
                        if (!string.IsNullOrEmpty(data[4]))
                            sfo.CustomerApplyNo = data[4];
                        if (!string.IsNullOrEmpty(data[5]))
                            sfo.PayDate = DateTime.Parse(DataConvertHelper.FormatDateTimeFromInt(data[5])).ToString("yyyy/MM/dd");
                    }
                    else if (templateType == AppliableFunctionType.SellerOrder)
                    {
                        ...
                        if (!string.IsNullOrEmpty(data[4]))
                            sfo.PayDate = DateTime.Parse(DataConvertHelper.FormatDateTimeFromInt(data[4])).ToString("yyyy/MM/dd");
                    }
                        ...
                        || templateType == AppliableFunctionType.SellerOrderMgr)
                    {
                        if (!string.IsNullOrEmpty(data[0]))
                            sfo.OrderNo = data[0];
                        if (!string.IsNullOrEmpty(data[1]))
                            sfo.Amount = DataConvertHelper.FormatNum(data[1]);
                    }
                    #endregion
                }
                catch { }
        ...
        public static List<SpplyFinancingOrder> GetSpplyFinancingOrderBOC(List<List<string>> contentData, AppliableFunctionType templateType)
        {
            List<SpplyFinancingOrder> list = new List<SpplyFinancingOrder>();
        ...
        public static List<SpplyFinancingBill> GetSpplyFinancingBill(List<List<string>> contentData, AppliableFunctionType templateType)
        {
            ...
            foreach (var data in contentData)
            {
                ...
                try
                {
                        ...
                        || templateType == AppliableFunctionType.BillofDebtReceivableSeller)
                    {
                        ...
                        if (!string.IsNullOrEmpty(data[4]))
                            sfb.CashType = DataConvertHelper.GetCashType(data[4]);
                        if (!string.IsNullOrEmpty(data[5]))
                            sfb.Amount = DataConvertHelper.FormatNum(data[5]);
                        if (!string.IsNullOrEmpty(data[6]))
                            sfb.BillDate = DateTime.Parse(DataConvertHelper.FormatDateTimeFromInt(data[6])).ToString("yyyy/MM/dd");
                        if (!string.IsNullOrEmpty(data[7]))
                            sfb.StartDate = DateTime.Parse(DataConvertHelper.FormatDateTimeFromInt(data[7])).ToString("yyyy/MM/dd");
                        if (!string.IsNullOrEmpty(data[8]))
                            sfb.EndDate = DateTime.Parse(DataConvertHelper.FormatDateTimeFromInt(data[8])).ToString("yyyy/MM/dd");
                    }
                    #endregion
                }
                catch { }
        ...
        public static List<SpplyFinancingBill> GetSpplyFinancingBillBOC(List<List<string>> contentData, AppliableFunctionType templateType)
        {
            List<SpplyFinancingBill> list = new List<SpplyFinancingBill>();
        ...
        public static List<SpplyFinancingPayOrReceipt> GetSpplyFinancingPayOrReceipt(List<List<string>> contentData, AppliableFunctionType templateType)
        {
            ...
            foreach (var data in contentData)
            {
                ...
                try
                {
                    ...
                    if (templateType == AppliableFunctionType.PaymentOrReceiptofDebtReceivablePurchaser)
                    {
                        ...
                        if (!string.IsNullOrEmpty(data[3]))
                            sfpor.CashType = DataConvertHelper.GetCashType(data[3]);
                        if (!string.IsNullOrEmpty(data[4]))
                            sfpor.PayAmountForThisTime = DataConvertHelper.FormatNum(data[4]);
                    }
                    #endregion
                }
                catch { }
        ...
        public static List<SpplyFinancingPayOrReceipt> GetSpplyFinancingPayOrReceiptBOC(List<List<string>> contentData, AppliableFunctionType templateType)
        {
            List<SpplyFinancingPayOrReceipt> list = new List<SpplyFinancingPayOrReceipt>();
        ...
        public static List<object> GetInitiativeAllot(List<string> contentData, AppliableFunctionType templateType)
        {
            List<object> result = new List<object>();
            BatchHeader batch = new BatchHeader();
            ...
            foreach (var data in contentData)
            {
                ...
                {
                    batch.ProtecolNo = strList[0];
                    batch.TransferDatetime = DateTime.Parse(DataConvertHelper.FormatDateTimeFromInt(strList[3]));
                    count++;
                    continue;
                }
                #endregion
                ...
                try
                {
                    ...
                    ae.Amount = DataConvertHelper.FormatNum(strList[5]);
                    if (!string.IsNullOrEmpty(strList[6]))
                        ae.Addition = strList[6];
                    if (!string.IsNullOrEmpty(ae.Amount.Trim())) ae.Amount = DataConvertHelper.FormatCash(ae.Amount, ae.CashType == CashType.JPY);
                }
                catch { ae.ErrorReason = "数据格式错误，转换失败"; }
                finally { if (null != ae) list.Add(ae); count++; }
                #endregion
        ...
        public static List<object> GetInitiativeAllotBOC(List<string> contentData, AppliableFunctionType templateType)
        {
            List<object> result = new List<object>();
            BatchHeader batch = new BatchHeader();
            List<InitiativeAllot> list = new List<InitiativeAllot>();
        ...
        public static List<object> GetInitiativeAllotBOCErrorLog(List<string> contentData, AppliableFunctionType templateType)
        {
            List<object> result = new List<object>();
            BatchHeader batch = new BatchHeader();
            List<InitiativeAllot> list = new List<InitiativeAllot>();
        ...
        public static List<UnitivePaymentRMB> GetUnitivePaymentRMB(List<string> contentData, AppliableFunctionType templateType)
        {
            ...
            foreach (var data in contentData)
            {
                ...
                try
                {
                    ...
                    if (!string.IsNullOrEmpty(strList[4]))
                        up.BankType = DataConvertHelper.GetAccountBankTypeObject(int.Parse(strList[4]));
                    if (!string.IsNullOrEmpty(strList[5]))
                    ...
                    if (!string.IsNullOrEmpty(strList[9]))
                        ...
                        //if (!string.IsNullOrEmpty(strList[11]))
                        up.Amount = DataConvertHelper.FormatCash(strList[9], false).Replace(",", "");
                    if (!string.IsNullOrEmpty(strList[10]))
                        up.Purpose = strList[10];
                    if (!string.IsNullOrEmpty(strList[11]))
                        up.UnitivePaymentType = DataConvertHelper.GetUnitivePaymentType(strList[11]);
                    if (!string.IsNullOrEmpty(strList[12]))
                    {
                        string[] temp = strList[12].Split(new string[] { " " }, StringSplitOptions.RemoveEmptyEntries);
                        up.OrderPayDate = DataConvertHelper.FormatDateTimeFromInt(temp[0]);
                        up.OrderPayTime = temp.Length < 2 ? "00:00" : DataConvertHelper.FormatTime(temp[1]);
                    }
                    if (!string.IsNullOrEmpty(strList[13]))
                        up.CustomerBusinissNo = strList[13];
                    if (!string.IsNullOrEmpty(strList[14]))
                        up.TransferChanelType = DataConvertHelper.GetTransferChanelType(strList[14]);
                    if (!string.IsNullOrEmpty(strList[15]))
                        up.IsTipPayee = DataConvertHelper.GetIsTipPayee(strList[15]);
                    if (!string.IsNullOrEmpty(strList[16]))
        ...
        public static List<UnitivePaymentRMB> GetUnitivePaymentRMBBOC(List<string> contentData, AppliableFunctionType templateType)
        {
            List<UnitivePaymentRMB> list = new List<UnitivePaymentRMB>();
        ...
        public static List<UnitivePaymentRMB> GetUnitivePaymentRMBBOCErrorLog(List<string> contentData, AppliableFunctionType templateType)
        {
            List<UnitivePaymentRMB> list = new List<UnitivePaymentRMB>();
        ...
        public static List<UnitivePaymentForeignMoney> GetUnitivePaymentFC(List<string> contentData, AppliableFunctionType templateType, OverCountryPayeeAccountType type)
        {
                ...
                try
                {
                    switch (type)
                    {
                        case OverCountryPayeeAccountType.BocAccount:
                            ...
                            if (!string.IsNullOrEmpty(strList[4]))
                                up.CashType = DataConvertHelper.GetCashType(strList[4]);
                            if (!string.IsNullOrEmpty(strList[5]))
                            ...
                            if (!string.IsNullOrEmpty(strList[8]))
                                up.Amount = DataConvertHelper.FormatCash(strList[8], false).Replace(",", "");
                            if (!string.IsNullOrEmpty(strList[9]))
                                up.CustomerBusinissNo = strList[9];
                            if (!string.IsNullOrEmpty(strList[10]))
                                up.Purpose = strList[10];
                            if (!string.IsNullOrEmpty(strList[11]))
                                up.OrderPayDate = DataConvertHelper.FormatDateTimeFromInt(strList[11]);
                            if (!string.IsNullOrEmpty(strList[12]))
                                up.Addtion = strList[12];
                            if (!string.IsNullOrEmpty(strList[13]))
                                up.CodeofCountry = strList[13];
                            if (!string.IsNullOrEmpty(strList[14]))
                                up.IsImportCancelAfterVerificationType = DataConvertHelper.GetIsImportCancelAfterVerificationType(strList[14]);
                            if (!string.IsNullOrEmpty(strList[15]))
                                up.UnitivePaymentType = DataConvertHelper.GetPayFeeType(strList[15]);
                            if (!string.IsNullOrEmpty(strList[16]))
                                up.PaymentNature = DataConvertHelper.GetPaymentPropertyType(strList[16]);
                            if (!string.IsNullOrEmpty(strList[17]))
                        ...
                        case OverCountryPayeeAccountType.OtherAccount:
                            ...
                            if (!string.IsNullOrEmpty(strList[4]))
                                up.CashType = DataConvertHelper.GetCashType(strList[4]);
                            if (!string.IsNullOrEmpty(strList[5]))
                                up.OrderPayDate = DataConvertHelper.FormatDateTimeFromInt(strList[5]);
                            if (!string.IsNullOrEmpty(strList[6]))
                                up.SendPriority = DataConvertHelper.GetTransferChanelType(strList[6]);
                            if (!string.IsNullOrEmpty(strList[7]))
                                up.Amount = DataConvertHelper.FormatCash(strList[7], false).Replace(",", "");
                            if (!string.IsNullOrEmpty(strList[8]))
                            ...
                            if (!string.IsNullOrEmpty(strList[23]))
                                up.IsImportCancelAfterVerificationType = DataConvertHelper.GetIsImportCancelAfterVerificationType(strList[23]);
                            if (!string.IsNullOrEmpty(strList[24]))
                                up.UnitivePaymentType = DataConvertHelper.GetPayFeeType(strList[24]);
                            if (!string.IsNullOrEmpty(strList[25]))
                                up.PaymentNature = DataConvertHelper.GetPaymentPropertyType(strList[25]);
                            if (!string.IsNullOrEmpty(strList[26]))
                            ...
                            if (!string.IsNullOrEmpty(strList[35]))
                                up.AssumeFeeType = DataConvertHelper.GetAssumeFeeType(strList[35].Trim());
                        ...
                        case OverCountryPayeeAccountType.ForeignAccount:
                            ...
                            if (!string.IsNullOrEmpty(strList[6]))
                                up.SendPriority = DataConvertHelper.GetTransferChanelType(strList[6]);
                            if (!string.IsNullOrEmpty(strList[7]))
                                up.UnitivePaymentType = DataConvertHelper.GetPayFeeType(strList[7]);
                            if (!string.IsNullOrEmpty(strList[8]))
                                up.Amount = DataConvertHelper.FormatCash(strList[8], false).Replace(",", "");
                            if (!string.IsNullOrEmpty(strList[9]))
                            ...
                            if (!string.IsNullOrEmpty(strList[24]))
                                up.FCPayeeAccountType = DataConvertHelper.GetUnitiveFCPayeeAccountType(strList[24]);
                            if (!string.IsNullOrEmpty(strList[25]))
                                up.PaymentCountryOrArea = DataConvertHelper.GetTransfer2CountryType(strList[25]);
                            if (!string.IsNullOrEmpty(strList[26]))
                                up.TransactionCode1 = strList[26];
                            if (!string.IsNullOrEmpty(strList[27]))
                                up.TransactionCode2 = strList[27];
                            ...
                            if (!string.IsNullOrEmpty(strList[38]))
                                up.NominalPayerAddress = strList[38];
                            if (!string.IsNullOrEmpty(strList[39]))
                                up.AssumeFeeType = DataConvertHelper.GetAssumeFeeType(strList[39].Trim());
                            #endregion
                            break;
                    }
                    if (!string.IsNullOrEmpty(up.Amount)) up.Amount = DataConvertHelper.FormatCash(up.Amount, up.CashType == CashType.JPY);
                    if (!string.IsNullOrEmpty(up.IPPSMoneyTypeAmount1)) up.IPPSMoneyTypeAmount1 = DataConvertHelper.FormatCash(up.IPPSMoneyTypeAmount1, up.CashType == CashType.JPY);
                    if (!string.IsNullOrEmpty(up.IPPSMoneyTypeAmount2)) up.IPPSMoneyTypeAmount2 = DataConvertHelper.FormatCash(up.IPPSMoneyTypeAmount2, up.CashType == CashType.JPY);
        ...
        public static List<UnitivePaymentForeignMoney> GetUnitivePaymentFCBOC(List<string> contentData, AppliableFunctionType templateType, OverCountryPayeeAccountType type)
        {
            List<UnitivePaymentForeignMoney> list = new List<UnitivePaymentForeignMoney>();
                    ...
                    switch (type)
                    {
                        case OverCountryPayeeAccountType.BocAccount:
                            ...
                            if (!string.IsNullOrEmpty(strList[7]))
                                up.PayeeOpenBankName = strList[7];
                            if (!string.IsNullOrEmpty(strList[8]))
                                up.Amount = DataConvertHelper.FormatCash(strList[8], up.CashType == CashType.JPY).Replace(",", "");
                            if (!string.IsNullOrEmpty(strList[9]))
                                up.CustomerBusinissNo = strList[9];
                            if (!string.IsNullOrEmpty(strList[10]))
                                up.Purpose = strList[10];
                            ...
                            if (!string.IsNullOrEmpty(strList[18]))
                                up.TransactionCode2 = strList[18];
                            if (!string.IsNullOrEmpty(strList[19]))
                                up.IPPSMoneyTypeAmount1 = DataConvertHelper.FormatCash(strList[19], up.CashType == CashType.JPY);
                            if (!string.IsNullOrEmpty(strList[20]))
                                up.IPPSMoneyTypeAmount2 = DataConvertHelper.FormatCash(strList[20], up.CashType == CashType.JPY);
                            if (!string.IsNullOrEmpty(strList[21]))
                                up.ContractNo = strList[21];
                            if (!string.IsNullOrEmpty(strList[22]))
                                up.InvoiceNo = strList[22];
                        ...
                        case OverCountryPayeeAccountType.OtherAccount:
                            ...
                            if (!string.IsNullOrEmpty(strList[6]))
                                up.SendPriority = DataConvertHelper.GetTransferChanelType(strList[6]);
                            if (!string.IsNullOrEmpty(strList[7]))
                                up.Amount = DataConvertHelper.FormatCash(strList[7], up.CashType == CashType.JPY).Replace(",", "");
                            if (!string.IsNullOrEmpty(strList[8]))
                                up.OrgCode = strList[8];
                            if (!string.IsNullOrEmpty(strList[9]))
                                up.CustomerBusinissNo = strList[9];
                            ...
                            if (!string.IsNullOrEmpty(strList[27]))
                                up.TransactionCode2 = strList[27];
                            if (!string.IsNullOrEmpty(strList[28]))
                                up.IPPSMoneyTypeAmount1 = DataConvertHelper.FormatCash(strList[28], up.CashType == CashType.JPY);
                            if (!string.IsNullOrEmpty(strList[29]))
                                up.IPPSMoneyTypeAmount2 = DataConvertHelper.FormatCash(strList[29], up.CashType == CashType.JPY);
                            if (!string.IsNullOrEmpty(strList[30]))
                                up.ContractNo = strList[30];
                            if (!string.IsNullOrEmpty(strList[31]))
                                up.InvoiceNo = strList[31];
                        ...
                        case OverCountryPayeeAccountType.ForeignAccount:
                            ...
                            if (!string.IsNullOrEmpty(strList[31]))
                                up.TransactionAddtion2 = strList[31];
                            if (!string.IsNullOrEmpty(strList[32]))
                                up.IsPayOffLine = DataConvertHelper.GetIsPayOffLine(strList[32]);
                            if (!string.IsNullOrEmpty(strList[33]))
                                up.ContractNo = strList[33];
                            if (!string.IsNullOrEmpty(strList[34]))
                                up.InvoiceNo = strList[34];
        ...
        public static List<UnitivePaymentForeignMoney> GetUnitivePaymentFCBOCErrorLog(List<string> contentData, AppliableFunctionType templateType)
        {
            List<UnitivePaymentForeignMoney> list = new List<UnitivePaymentForeignMoney>();
        ...
        public static List<TransferGlobal> GetTransferGlobalBarBOC(List<string> contentData, AppliableFunctionType templateType)
        {
            List<TransferGlobal> list = new List<TransferGlobal>();
            int index = 0;
            int maxcount = 0;
            ...
            foreach (var data in contentData)
            {
                if (templateType == AppliableFunctionType.TransferOverCountry4Bar)
                {
                    ...
                    else if (index <= maxcount)
                    {
                        ...
                        tg.PaymentCashType = DataConvertHelper.GetCashType(fileHeaders[6]);
                        tg.PayFeeAccount = fileHeaders[2];

                        tg.PaymentType = "电汇";
                        try
                        {
                            tg.SendPriority = DataConvertHelper.GetTransferChanelType((int.Parse(details[0]) - 1).ToString());
                        }
                        catch { }
                        tg.RemitAmount = DataConvertHelper.FormatCash((double.Parse(details[1]) / 100).ToString(), tg.PaymentCashType == CashType.JPY);
                        ...
                        tg.AssumeFeeType = DataConvertHelper.GetAssumeFeeType(details[16]);
                        tg.PayeeCodeofCountry = details[17];
                        tg.PayeeNameofCountry = details[18];
                        tg.PayFeeType = DataConvertHelper.GetPayFeeType(details[19]);
                        ...
                        tg.IsPayOffLine = DataConvertHelper.GetIsPayOffLine(details[26]);
                ...
                else if (templateType == AppliableFunctionType.TransferForeignMoney4Bar)
                {
                    ...
                    else if (index <= maxcount)
                    {
                        ...
                        if (bankType == AccountBankType.BocAccount)
                        {
                            ...
                            tg.RemitAmount =
                            tg.SpotAmount = string.IsNullOrEmpty(details[2]) ? "" : (double.Parse(details[2]) / 100).ToString();
                            tg.Province = DataConvertHelper.GetProvince(details[3]);
                            tg.CertifyPaperType = DataConvertHelper.GetAgentExpressCertifyPaperType(details[4]);
                            tg.CertifyPaperNo = details[5];
                            tg.Bar_Addition = details[6];
                            tg.AgentFunctionType_Express = DataConvertHelper.GetAgentExpressFunctionType(details[12]);
                            if (tg.AgentFunctionType_Express == AgentExpressFunctionType.Empty) tg.AgentFunctionType_Express = DataConvertHelper.GetAgentExpressFunctionType(fileHeaders[5]);
                            tg.PayFeeAccount = fileHeaders[2];
                        }
                        else if (bankType == AccountBankType.OtherBankAccount)
                        {
                            ...
                            tg.BarBusinessType = DataConvertHelper.GetBarBusinessType(details[6]);//业务种类
                            tg.BarApplyFlagType = DataConvertHelper.GetBarApplyFlagType(details[7]);//申报标示
                            ...
                            try
                            {
                                tg.SendPriority = DataConvertHelper.GetTransferChanelType((int.Parse(details[11]) - 1).ToString());
                            }
                            catch { }
                            ...
                            tg.AssumeFeeType = DataConvertHelper.GetAssumeFeeType(details[26]);
                            tg.PayeeCodeofCountry = details[27];
                            tg.PayeeNameofCountry = details[28];
                            tg.PayFeeType = DataConvertHelper.GetPayFeeType(details[29]);
                            tg.PaymentPropertyType = DataConvertHelper.GetPaymentPropertyTypeBar(details[30]);
                            ...
                            tg.IsPayOffLine = DataConvertHelper.GetIsPayOffLine(details[35]);
        ...
        public static List<object> GetAgentExpressBarBOC(List<string> contentData, AppliableFunctionType templateType)
        {
            List<object> result = new List<object>();
            List<AgentExpress> list = new List<AgentExpress>();
            int index = 0;
            ...
            foreach (var data in contentData)
            {
                if (templateType == AppliableFunctionType.AgentExpressOut4Bar)
                {
                    if (index == 0)
                    {
                        ...
                        maxcount = int.Parse(fileHeaders[4]);
                        bh.AgentFunctionType_Express = DataConvertHelper.GetAgentExpressFunctionType(fileHeaders[5]);
                        index++;
                    }
                    else if (index <= maxcount)
                    {
                        ...
                        if (!string.IsNullOrEmpty(details[12]))
                            tg.UsageType = DataConvertHelper.GetAgentExpressFunctionType(details[12]);
        ...
        public static List<VirtualAccount> GetVirtualAccount(List<string> contentData, AppliableFunctionType templateType)
        {
            List<object> result = new List<object>();
            ...
            foreach (var data in contentData)
            {
                ...
                try
                {
                    ...
                    if (!string.IsNullOrEmpty(ae.Amount)) ae.Amount = DataConvertHelper.FormatCash(ae.Amount, ae.CashType == CashType.JPY);
                }
                catch { /*ae.ErrorReason = "数据格式错误，转换失败"; */}
                finally { if (null != ae) list.Add(ae); count++; }
                #endregion
        ...
        public static List<VirtualAccount> GetVirtualAccountBOC(List<string> contentData, AppliableFunctionType templateType)
        {
            List<object> result = new List<object>();
            BatchHeader batch = new BatchHeader();
            List<VirtualAccount> list = new List<VirtualAccount>();
            ...
            foreach (var data in contentData)
            {
                ...
                try
                {
                    ...
                    if (!string.IsNullOrEmpty(strList[3]))
                        ae.NameIn = strList[3];
                    if (!string.IsNullOrEmpty(strList[4]))
                        ae.CashType = DataConvertHelper.GetCashType(strList[4]);
                    ae.Amount = DataConvertHelper.FormatNum(strList[5]);
                    if (!string.IsNullOrEmpty(strList[6]))
                        ae.Purpose = strList[6];
                    if (!string.IsNullOrEmpty(strList[7]))
        ...
        public static List<VirtualAccount> GetVirtualAccountBOCErrorLog(List<string> contentData, AppliableFunctionType templateType)
        {
            List<object> result = new List<object>();
            BatchHeader batch = new BatchHeader();
            List<VirtualAccount> list = new List<VirtualAccount>();
        ...
        public static List<PreproccessTransfer> GetPreproccessTransfer(List<string> contentData, AppliableFunctionType templateType)
        {
            List<object> result = new List<object>();
            ...
            foreach (var data in contentData)
            {
                ...
                #region 笔信息
                ae = new PreproccessTransfer();
                try
                {
                    if (!string.IsNullOrEmpty(strList[0]))
                        ae.PreproccessName = strList[0];
                    if (!string.IsNullOrEmpty(strList[1]))
                        ae.PreproccessAccount = strList[1];
                    if (!string.IsNullOrEmpty(strList[2]))
                        ae.CashType = DataConvertHelper.GetCashType(strList[2]);
                    if (!string.IsNullOrEmpty(strList[3]))
                        ae.PreproccessAmount = strList[3];
                    if (!string.IsNullOrEmpty(strList[4]))
                        ae.MainAccount = strList[4];
                    if (!string.IsNullOrEmpty(strList[5]))
                        ae.TradeSerialNo = strList[5];
                    if (!string.IsNullOrEmpty(strList[6]))
                        ae.BatchTradeSerialNo = strList[6];
                    if (!string.IsNullOrEmpty(strList[7]))
                        ae.InvolvedName = strList[7];
                    if (!string.IsNullOrEmpty(strList[8]))
                        ae.InvolvedAccount = strList[8];
                    if (!string.IsNullOrEmpty(strList[9]))
                        ae.TradeDate = DataConvertHelper.FormatDateTimeFromInt(strList[9]);
                    if (!string.IsNullOrEmpty(strList[10]))
                        ae.Content = strList[10];
                    if (!string.IsNullOrEmpty(strList[11]))
                        ae.VirtualAccount = strList[11];
                    if (!string.IsNullOrEmpty(strList[12]))
                        ae.Amount = strList[12];
                    if (!string.IsNullOrEmpty(ae.Amount)) ae.Amount = DataConvertHelper.FormatCash(ae.Amount, ae.CashType == CashType.JPY);
                    if (!string.IsNullOrEmpty(ae.PreproccessAmount)) ae.PreproccessAmount = DataConvertHelper.FormatCash(ae.PreproccessAmount, ae.CashType == CashType.JPY);
                }
                catch { /*ae.ErrorReason = "数据格式错误，转换失败"; */}
                finally { if (null != ae) list.Add(ae); count++; }
                #endregion
        ...
        public static List<PreproccessTransfer> GetPreproccessTransferBOC(List<string> contentData, AppliableFunctionType templateType)
        {
            List<object> result = new List<object>();
            BatchHeader batch = new BatchHeader();
            List<PreproccessTransfer> list = new List<PreproccessTransfer>();
            ...
            foreach (var data in contentData)
            {
                ...
                try
                {
                    ...
                    if (!string.IsNullOrEmpty(strList[2]))
                        ae.CashType = DataConvertHelper.GetCashType(strList[2]);
                    if (!string.IsNullOrEmpty(strList[3]))
                        ae.PreproccessAmount = DataConvertHelper.FormatNum(strList[3]);
                    if (!string.IsNullOrEmpty(strList[4]))
                        ae.MainAccount = strList[4];
                    if (!string.IsNullOrEmpty(strList[5]))
                        ae.TradeSerialNo = strList[5];
                    ...
                    if (!string.IsNullOrEmpty(strList[11]))
                        ae.VirtualAccount = strList[11];
                    if (!string.IsNullOrEmpty(strList[12]))
                        ae.Amount = DataConvertHelper.FormatNum(strList[12]);
                    if (!string.IsNullOrEmpty(ae.Amount)) ae.Amount = DataConvertHelper.FormatCash(ae.Amount, ae.CashType == CashType.JPY);
                    if (!string.IsNullOrEmpty(ae.PreproccessAmount)) ae.PreproccessAmount = DataConvertHelper.FormatCash(ae.PreproccessAmount, ae.CashType == CashType.JPY);
                }
                catch {/* ae.ErrorReason = "数据格式错误，转换失败"; */}
        ...
        public static List<PreproccessTransfer> GetPreproccessTransferBOCCSV(List<string> contentData, AppliableFunctionType templateType)
        {
            List<object> result = new List<object>();
            BatchHeader batch = new BatchHeader();
            List<PreproccessTransfer> list = new List<PreproccessTransfer>();
            ...
            {
                ae = null;
                string[] strList = AnalyseBOCCSVSytleData(contentData[maxcount]);
        ...
        public static List<PreproccessTransfer> GetPreproccessTransferBOCErrorLog(List<string> contentData, AppliableFunctionType templateType)
        {
            List<object> result = new List<object>();
            BatchHeader batch = new BatchHeader();
            List<PreproccessTransfer> list = new List<PreproccessTransfer>();
        ...
        public static List<BatchReimbursement> GetBatchReimbursement(List<string> contentData, AppliableFunctionType templateType)
        {
            List<object> result = new List<object>();
            ...
            foreach (var data in contentData)
            {
                ...
                #region 笔信息
                ae = new BatchReimbursement();
                try
                {
                    if (!string.IsNullOrEmpty(strList[0]))
                        ae.CardNo = strList[0];
                    if (!string.IsNullOrEmpty(strList[1]))
                        ae.PayAmount = strList[1];
                    if (!string.IsNullOrEmpty(strList[2]))
                        ae.PayDateTime = DataConvertHelper.FormatDateTimeFromInt(strList[2]);
                    if (!string.IsNullOrEmpty(strList[3]))
                        ae.PayPassword = strList[3];
                    if (!string.IsNullOrEmpty(strList[4]))
                        ae.ReimburseAmount = strList[4];
                    if (!string.IsNullOrEmpty(strList[5]))
                        ae.Usage = strList[5];
                }
                catch { /*ae.ErrorReason = "数据格式错误，转换失败"; */}
        ...
        public static List<BatchReimbursement> GetBatchReimbursementBOC(List<string> contentData, AppliableFunctionType templateType)
        {
            List<object> result = new List<object>();
            BatchHeader batch = new BatchHeader();
            List<BatchReimbursement> list = new List<BatchReimbursement>();
        ...
        public static List<BatchReimbursement> GetBatchReimbursementBOCErrorLog(List<string> contentData, AppliableFunctionType templateType)
        {
            List<object> result = new List<object>();
            List<BatchReimbursement> list = new List<BatchReimbursement>();
        ...
        public static List<GovermentInfo> GetGoverment(List<string> contentData, AppliableFunctionType templateType)
        {
            List<GovermentInfo> list = new List<GovermentInfo>();
            ...
            foreach (var data in contentData)
            {
                ...
                try
                {
                    if (!string.IsNullOrEmpty(strList[0]))
                        ta.CustomerRef = strList[0];
                    if (!string.IsNullOrEmpty(strList[1]))
                        ta.PayerAccount = strList[1];
                    else if (string.IsNullOrEmpty(ta.ErrorReason))
                        ta.ErrorReason = "付款人账号为空";
                    if (!string.IsNullOrEmpty(strList[2]))
                        ta.PayeeAccount = strList[2];
                    else if (string.IsNullOrEmpty(ta.ErrorReason))
                        ta.ErrorReason = "收款人账号为空";
                    if (!string.IsNullOrEmpty(strList[3]))
                        ta.PayeeOpenBank = strList[3];
                    else if (string.IsNullOrEmpty(ta.ErrorReason))
                        ta.ErrorReason = "收款行名称为空";
                    if (!string.IsNullOrEmpty(strList[4]))
                        ta.PayeeName = strList[4];
                    else if (string.IsNullOrEmpty(ta.ErrorReason))
                        ta.ErrorReason = "收款人名称为空";
                    if (!string.IsNullOrEmpty(strList[5]))
                        ta.PayAmount = strList[5];
                    else if (string.IsNullOrEmpty(ta.ErrorReason))
                        ta.ErrorReason = "付款金额为空";
                    if (!string.IsNullOrEmpty(strList[6]))
                        ta.PayDatetime = strList[6];
                    else if (string.IsNullOrEmpty(ta.ErrorReason))
                        ta.ErrorReason = "指定付款日期为空";
                    if (!string.IsNullOrEmpty(strList[7]))
                        ta.Addition = strList[7];
                    else if (string.IsNullOrEmpty(ta.ErrorReason))
                        ta.ErrorReason = "用途为空";
                    if (!string.IsNullOrEmpty(strList[8]))
                        ta.PayeeCode = strList[8];
                    else if (string.IsNullOrEmpty(ta.ErrorReason))
                        ta.ErrorReason = "支付令编码为空";
                    if (!string.IsNullOrEmpty(strList[9]))
                        ta.OddNumber = strList[9];
                    if (!string.IsNullOrEmpty(strList[10]))
                        ta.AccountBankType = (AccountBankType)((int.Parse(strList[10]) + 1) % 2);
                    else if (string.IsNullOrEmpty(ta.ErrorReason))
                        ta.ErrorReason = "是否中行收款标志为空";
                    if (!string.IsNullOrEmpty(strList[11]))
                        ta.CNAPSNo = strList[11];
                }
                catch { ta.ErrorReason = MultiLanguageConvertHelper.DesignMain_InvalidDta_ChangeFile_Fail; }
                finally
                {
        ...
        public static List<GovermentInfo> GetGovermentBOC(List<string> contentData, AppliableFunctionType templateType)
        {
            List<GovermentInfo> list = new List<GovermentInfo>();
        ...
        private static List<string> AnalyseBarStyleData(string data, List<int> dataLengths)
        {
        ...
        private static string GetStringByBtyeLenght(string data, int sindex, int length)
        {
            string result = string.Empty;
            result = Encoding.Default.GetString(Encoding.UTF8.GetBytes(data), sindex, length);
            return result;
        }
        ...
        private static int GetByteLength(string data)
        {
            ...
            if (!string.IsNullOrEmpty(data))
                lenght = Encoding.UTF8.GetBytes(data).Length;
            return lenght;
        }
    }
}
