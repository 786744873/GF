...
{
    public static class TemplateHeaderAndFooterHelper
    {
        /// <summary>
        /// 获取模板类型对应的模板头信息
        /// </summary>
        ...
        /// <returns></returns>
        public static string CreateTemplateHeaderInfo(AppliableFunctionType tempType, IList<string> list, string separator)
        {
            ...
            switch (tempType)
            {
                ...
                case AppliableFunctionType.ElecTicketRemit:
                    headerInfo = "DRAFTBOOK" + separator; break;
                case AppliableFunctionType.ElecTicketBackNote:
                    headerInfo = "DRAFTTRANSFER" + separator; break;
                case AppliableFunctionType.ElecTicketPayMoney:
                    headerInfo = "RDSAPPLY" + separator; break;
                case AppliableFunctionType.ElecTicketTipExchange:
                    headerInfo = "DRAFTREMIND" + separator; break;
                ...
                case AppliableFunctionType.UnitivePaymentRMB:
                    headerInfo = "GCMSMP" + separator; break;
                ...
                case AppliableFunctionType.VirtualAccountTransfer:
                    headerInfo = "ITESTART" + separator; break;
                case AppliableFunctionType.PreproccessTransfer:
                    headerInfo = "TEFPSTART" + separator; break;
                case AppliableFunctionType.BatchReimbursement:
                    headerInfo = "RECORD" + separator; break;
                default: break;
            }
        ...
        /// <param name="tempType">模板的类型</param>
        /// <returns></returns>
        public static string CreateTemplateHeaderInfo(FunctionInSettingType tempType, int count, string separator)
        {
            string headerInfo = string.Empty;
            switch (tempType)
            {
        ...
        /// <returns></returns>
        public static string GetTemplateHeaderStarts(AppliableFunctionType tempType)
        ...
        /// <param name="tempType">模板类型</param>
        /// <returns></returns>
        public static string GetTemplateHeaderStarts(AppliableFunctionType tempType, OverCountryPayeeAccountType at)
        {
            string headerInfo = string.Empty;
            switch (tempType)
            {
                ...
                case AppliableFunctionType.UnitivePaymentFC:
                    ...
                    break;
                case AppliableFunctionType.VirtualAccountTransfer:
                    headerInfo = "ITESTART|"; break;
                case AppliableFunctionType.PreproccessTransfer:
                    headerInfo = "TEFPSTART|"; break;
                case AppliableFunctionType.BatchReimbursement:
                    headerInfo = "RECORD|"; break;
                default: break;
            }
        ...
        /// <returns></returns>
        public static string GetTemplateTableColumnsHeader(AppliableFunctionType tempType)
        {
        ...
        /// <returns></returns>
        public static string CreateFileHeaderInfoBar(AppliableFunctionType aft, TransferGlobal tg, string separactorChar, double amount, int maxcount)
        {
            ...
            if (aft == AppliableFunctionType.TransferOverCountry4Bar)
            {
                #region
                header.Append("C6");
                header.Append(SystemSettings.CustomerInfo.Code);
        ...
        /// <param name="maxcount"></param>
        /// <returns></returns>
        public static string CreateFileHeaderInfoBar(AppliableFunctionType aft, BatchHeader bh, string separactorChar, double amount, int maxcount)
        {
            StringBuilder header = new StringBuilder();
        ...
        /// <param name="tempType">模板类型</param>
        /// <returns></returns>
        public static string GetTemplateHeaderStarts(FunctionInSettingType tempType)
        {
            string headerInfo = string.Empty;
            switch (tempType)
            {
        ...
        /// <param name="tempType">模板类型</param>
        /// <returns></returns>
        public static string GetTemplateFooterInfo(AppliableFunctionType tempType)
        ...
        /// <param name="tempType">模板类型</param>
        /// <returns></returns>
        public static string GetTemplateFooterInfo(AppliableFunctionType tempType, OverCountryPayeeAccountType at)
        {
            ...
            switch (tempType)
            {
                ...
                case AppliableFunctionType.PreproccessTransfer:
                    footerInfo = "TEFPEND"; break;
                case AppliableFunctionType.BatchReimbursement:
                    footerInfo = "RECORDEND";break;
                default: break;
            }
            return footerInfo;
        }
        ...
        /// <param name="tempType">模板类型</param>
        /// <returns></returns>
        public static string GetTemplateFooterInfo(FunctionInSettingType tempType)
        {
            string headerInfo = string.Empty;
            switch (tempType)
            {
